...
Data:
   ...
   img/g5-remove-red.png          - result of remove_red()
   img/g5-remove-red-bug.png      - result of a buggy remove_red()
...
by 600 pixels.
   ...
   % imagediff -i img/g5-remove-red.png -j img/g5-remove-red-bug.png
   Loaded image img/g5-remove-red.png. Dimensions are 800 by 600.
   Loaded image img/g5-remove-red-bug.png. Dimensions are 800 by 600.
...
the places where differences occured:
   ...
   % imagediff -i img/g5-remove-red.png -j img/g5-remove-red-bug.png -o diff.png
   % display diff.png &
...
Compiling remove-red and test cases:
   % cc0 -d -W -w -o remove-red-test pixel.o0 imageutil.c0 remove-red.c0 remove-red-test.c0
   % ./remove-red-test

   % cc0 -d -W -w -o remove-red pixel.o0 imageutil.c0 remove-red.c0 remove-red-main.c0
   % ./remove-red -i img/g5.png -o img/g5-my-output.png
       (This creates the output file img/g5-my-output.png. If you
        left off the "-o img/g5-my-output.png" part, the output
        file would be called img/g5_remove-red.png.)
